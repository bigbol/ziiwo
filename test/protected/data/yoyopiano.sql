...
-- ----------------------------
-- Table structure for `inmobi_data`
-- ----------------------------
DROP TABLE IF EXISTS `inmobi_data`;
CREATE TABLE `inmobi_data` (
  `accountId` varchar(32) NOT NULL,
  `accountName` varchar(20) DEFAULT NULL,
  `site` varchar(32) DEFAULT NULL,
  `country` varchar(200) DEFAULT NULL,
  `adImpressions` int(10) DEFAULT NULL,
  `adRequests` int(10) DEFAULT NULL,
  `clicks` int(10) DEFAULT NULL,
  `earnings` float DEFAULT NULL,
  `CTR` decimal(10,0) DEFAULT NULL,
  `costPerClick` decimal(10,0) DEFAULT NULL,
  `date` datetime DEFAULT NULL COMMENT '报告进行合计时的日期',
  PRIMARY KEY (`accountId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of inmobi_data
-- ----------------------------
